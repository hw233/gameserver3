...
tab_robot_war = Table("robot_war", metadata,
...
class TRobotWar(TableObject):
    ...
    def __repr__(self):
        return 'uid=%d,online_times=%s,type=%d,win_gold=%d,state=%d' % (self.uid, self.online_times,self.type,self.win_gold,self.state)
